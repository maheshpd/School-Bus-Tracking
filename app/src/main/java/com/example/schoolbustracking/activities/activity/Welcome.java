...
public class Welcome extends FragmentActivity implements OnMapReadyCallback,
    ...
    public static final int PLAY_SERVICE_REQUEST = 7001;
...
//        });
        ...
        //Geo Fire
//        drivers = FirebaseDatabase.getInstance().getReference("Driver").getRef();
////        DriverModel driverModel = new DriverModel();
////        drivers.child("Mahesh Prasad");
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
            if (location_switch.isChecked()) {
                ...
                //update To Firebase
                DatabaseReference driverAvailibilityRef = FirebaseDatabase.getInstance().getReference().child("Driver Available");
                GeoFire geoFire = new GeoFire(driverAvailibilityRef);

                geoFire.setLocation(busno, new GeoLocation(latitude, longitude), new GeoFire.CompletionListener() {
                    @Override
                    public void onComplete(String key, DatabaseError error) {
                        //Add Marker
                        if (mCurrent != null)
                            mCurrent.remove(); //Remove already markerx
...
//                                .icon(BitmapDescriptorFactory.fromResource(R.drawable.car))
            ...
            Log.d("ERROR","Cannot get ypur location");
        }
    }
